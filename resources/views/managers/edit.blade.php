  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Stadium Manager</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Stadium Manager</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-primary col-xs-8 col-sm-8">
              <div class="card-header">
                <h3 class="card-title">Edit Stadium Manager</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
@method('PUT')
                <div class="card-body">
                  <div class="form-group">
					...
					<input type="text" name="FirstName" class="form-control" value="{{ $manager->FirstName }}" placeholder="First Name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Last Name</label>
                    <input type="text" name="LastName" class="form-control" value="{{ $manager->LastName }}" placeholder="Last Name">
                  </div>
                ...
                <option value="Burundi">Burundi</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="Phone" class="form-control" value="{{ $manager->Phone }}" placeholder="Phone">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
				 ...
				 &nbsp; <a href="{{ route('managers.index') }}" class="btn btn-primary" > <i class="fas fa-arrow-left"></i> Back</a>
                </div>
              </form>
            </div>
