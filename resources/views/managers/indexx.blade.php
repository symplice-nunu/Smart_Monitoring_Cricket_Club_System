        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('clubManager') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Club Manager</p>
                </a>
              </li>
...
<div class="col-lg-12 margin-tb">
    ...
    <div class="pull-right" style="margin-bottom: 1em;">
        ...
        <i class="fas fa-plus"></i> New Club Manager
  </button>&nbsp;&nbsp;&nbsp;
  <a href="{{ url('generate-club-manager-pdf') }}" class="btn btn-primary">
...
<tr>
  <?php
if($manager->ManagerType == 'Club Manager'){
  ?>
  <td>{{ ++$i }}</td>
