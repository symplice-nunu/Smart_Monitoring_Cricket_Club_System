        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('approved') }}" class="nav-link active">
...
<div class="col-lg-12 margin-tb">
    ...
    <div class="pull-left">
        ...
        <h2>Approved Application List</h2>

    </div>

    <div class="pull-right" style="margin-bottom: 1em;">

    <a href="{{ url('generate-new-approved-pdf') }}" class="btn btn-primary">
        <i class="fas fa-download"></i> Download
</a>
  
<div style=" text-align: right;">
                <input id="myInput" class="form-control col-lg-3" type="text" placeholder="Search.." style="height: 2em; margin-left: 49.6em;  margin-top: -2.3em;">
    </div>
    </div>
